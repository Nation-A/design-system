...
function UploadOutlineIcon({ size = 24, color = 'currentColor', ...props }: Props) {
  return (
    ...
    >
      ...
      />
      <path
        d="M6.00024 6H13.7465C14.2988 6 14.7465 5.55228 14.7465 5C14.7465 4.44772 14.2988 4 13.7465 4H5.87087C4.83756 4 4.00024 4.83895 4.00024 5.87124V18.1288C4.00024 19.1611 4.83757 20 5.87087 20H18.1296C19.1629 20 20.0002 19.1611 20.0002 18.1288V10.2475C20.0002 9.69521 19.5525 9.2475 19.0002 9.2475C18.448 9.2475 18.0002 9.69521 18.0002 10.2475V18H6.00024V6Z"
        fill="currentColor"
      />
      <path
