import { Children, cloneElement, useEffect, useImperativeHandle, useMemo, useRef } from 'react'
...
import { useModalEffect, useDimensions, useIsomorphicLayoutEffect, useEffectEvent } from './hooks'
...
export const Sheet = ({
  ...
  const sheet = (
    <SheetContext.Provider value={context}>
      <motion.div {...rest} ref={ref} style={{ ...styles.wrapper, zIndex, visibility, ...style }}>
        <AnimatePresence>
          {/* NOTE: AnimatePresence requires us to set keys to children */}
          {isOpen ? (
            <SheetScrollerContextProvider>
              {Children.map(children as React.ReactElement[], (child: React.ReactElement, i) =>
