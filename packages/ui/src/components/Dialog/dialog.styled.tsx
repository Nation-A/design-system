...
import { dialogRecipe, type DialogRecipeVariantProps } from './dialog.recipe'
const { withRootProvider, withContext } = createStyleContext(dialogRecipe)

export type RootProviderProps = ComponentProps<typeof RootProvider>
export const RootProvider = withRootProvider<Assign<Dialog.RootProviderProps, DialogRecipeVariantProps>>(
  Dialog.RootProvider,
)

export type RootProps = ComponentProps<typeof Root>
export const Root = withRootProvider<Assign<Dialog.RootProps, DialogRecipeVariantProps>>(Dialog.Root)
